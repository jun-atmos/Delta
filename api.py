...
def download_file(tm2):
    ...
    wea_save_file_path = f'/workspaces/Delta/weather_csv/wea_{tm2}.csv'
    cloud_save_file_path = f'/workspaces/Delta/weather_csv/cloud_{tm2}.csv'
    vi_save_file_path = f'/workspaces/Delta/weather_csv/vi_{tm2}.csv'
